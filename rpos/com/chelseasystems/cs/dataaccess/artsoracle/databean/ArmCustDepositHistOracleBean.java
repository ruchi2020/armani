...
/**
 *
 * This class is an object representation of the Arts database table ARM_CUST_DEPOSIT_HIST<BR>
...
+------+------------+-----------+-----------+----------------------------------------------------+
| 1    | 03-06-2006 | Sandhya   | PCR1326	| Do not recreate the bean using daogen.             |
|      |            |           |           | Make changes to the existing bean.                 | 
+------+------------+-----------+-----------+----------------------------------------------------+
*/
public class ArmCustDepositHistOracleBean extends BaseOracleBean {

  public ArmCustDepositHistOracleBean() {}

  public static String selectSql = "select DC_TRANSACTION, ID_STR_RT, AI_TRN, TY_TRN, ASSOC, AMOUNT, CUST_ID, FL_DELETED, NULL FN_PRS, NULL LN_PRS, NULL DE_STR_RT from ARM_CUST_DEPOSIT_HIST ";
  public static String insertSql = "insert into ARM_CUST_DEPOSIT_HIST (DC_TRANSACTION, ID_STR_RT, AI_TRN, TY_TRN, ASSOC, AMOUNT, CUST_ID, FL_DELETED) values (?, ?, ?, ?, ?, ?, ?, ?)";
  public static String updateSql = "update ARM_CUST_DEPOSIT_HIST set DC_TRANSACTION = ?, ID_STR_RT = ?, AI_TRN = ?, TY_TRN = ?, ASSOC = ?, AMOUNT = ?, CUST_ID = ?, FL_DELETED = ? ";
  public static String deleteSql = "delete from ARM_CUST_DEPOSIT_HIST ";
  //PCR1326 DepositHistory fix for Armani Japan
  public static String depositHistorySql = "select A.DC_TRANSACTION DC_TRANSACTION, A.ID_STR_RT ID_STR_RT, " +
  "A.AI_TRN AI_TRN, A.TY_TRN TY_TRN, A.ASSOC ASSOC, A.AMOUNT AMOUNT, A.CUST_ID CUST_ID, A.FL_DELETED FL_DELETED, " + 
  "B.FN_PRS FN_PRS, B.LN_PRS LN_PRS, C.DE_STR_RT DE_STR_RT from ARM_CUST_DEPOSIT_HIST A, PA_PRS B, PA_STR_RTL C " + 
  "where A.ASSOC = B.ID_PRTY_PRS and A.ID_STR_RT = C.ID_STR_RT and A.CUST_ID = ? " +
  "AND A.FL_DELETED NOT IN ?";
  
  public static String depositHistorySqlForStore = "select A.DC_TRANSACTION DC_TRANSACTION, A.ID_STR_RT ID_STR_RT, " +
  "A.AI_TRN AI_TRN, A.TY_TRN TY_TRN, A.ASSOC ASSOC, A.AMOUNT AMOUNT, A.CUST_ID CUST_ID, A.FL_DELETED FL_DELETED, " + 
  "B.FN_PRS FN_PRS, B.LN_PRS LN_PRS, C.DE_STR_RT DE_STR_RT from ARM_CUST_DEPOSIT_HIST A, PA_PRS B, PA_STR_RTL C " + 
  ...
  public static String TABLE_NAME = "ARM_CUST_DEPOSIT_HIST";
  public static String COL_DC_TRANSACTION = "ARM_CUST_DEPOSIT_HIST.DC_TRANSACTION";
  public static String COL_ID_STR_RT = "ARM_CUST_DEPOSIT_HIST.ID_STR_RT";
  public static String COL_AI_TRN = "ARM_CUST_DEPOSIT_HIST.AI_TRN";
  public static String COL_TY_TRN = "ARM_CUST_DEPOSIT_HIST.TY_TRN";
  public static String COL_ASSOC = "ARM_CUST_DEPOSIT_HIST.ASSOC";
  public static String COL_AMOUNT = "ARM_CUST_DEPOSIT_HIST.AMOUNT";
  public static String COL_CUST_ID = "ARM_CUST_DEPOSIT_HIST.CUST_ID";
  ...
  public String getDepositHistorySql() { return depositHistorySql; }
  ...
  public BaseOracleBean[] getDatabeans(ResultSet rs) throws SQLException {
    ...
    return (ArmCustDepositHistOracleBean[]) list.toArray(new ArmCustDepositHistOracleBean[0]);
  }
