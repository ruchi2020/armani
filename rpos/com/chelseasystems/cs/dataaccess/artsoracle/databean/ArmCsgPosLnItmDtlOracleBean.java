...
/**
 *
 * This class is an object representation of the Arts database table ARM_CSG_POS_LN_ITM_DTL<BR>
 ...
 *     FL_VD_LN_ITM -- CHAR(1)<BR>
 *
 */
public class ArmCsgPosLnItmDtlOracleBean extends BaseOracleBean {

  public ArmCsgPosLnItmDtlOracleBean() {}

  public static String selectSql = "select AI_TRN, AI_LN_ITM, SEQUENCE_NUM, ORG_AI_TRN, ORIG_AI_LN_ITM, ORIG_SEQ_NUM, FL_VD_LN_ITM from ARM_CSG_POS_LN_ITM_DTL ";
  public static String insertSql = "insert into ARM_CSG_POS_LN_ITM_DTL (AI_TRN, AI_LN_ITM, SEQUENCE_NUM, ORG_AI_TRN, ORIG_AI_LN_ITM, ORIG_SEQ_NUM, FL_VD_LN_ITM) values (?, ?, ?, ?, ?, ?, ?)";
  public static String updateSql = "update ARM_CSG_POS_LN_ITM_DTL set AI_TRN = ?, AI_LN_ITM = ?, SEQUENCE_NUM = ?, ORG_AI_TRN = ?, ORIG_AI_LN_ITM = ?, ORIG_SEQ_NUM = ?, FL_VD_LN_ITM = ? ";
  public static String updateVoidSql = "update ARM_CSG_POS_LN_ITM_DTL set FL_VD_LN_ITM = ?";
  public static String deleteSql = "delete from ARM_CSG_POS_LN_ITM_DTL ";

  public static String TABLE_NAME = "ARM_CSG_POS_LN_ITM_DTL";
  public static String COL_AI_TRN = "ARM_CSG_POS_LN_ITM_DTL.AI_TRN";
  public static String COL_AI_LN_ITM = "ARM_CSG_POS_LN_ITM_DTL.AI_LN_ITM";
  public static String COL_SEQUENCE_NUM = "ARM_CSG_POS_LN_ITM_DTL.SEQUENCE_NUM";
  public static String COL_ORG_AI_TRN = "ARM_CSG_POS_LN_ITM_DTL.ORG_AI_TRN";
  public static String COL_ORIG_AI_LN_ITM = "ARM_CSG_POS_LN_ITM_DTL.ORIG_AI_LN_ITM";
  public static String COL_ORIG_SEQ_NUM = "ARM_CSG_POS_LN_ITM_DTL.ORIG_SEQ_NUM";
  public static String COL_FL_VD_LN_ITM = "ARM_CSG_POS_LN_ITM_DTL.FL_VD_LN_ITM";
  ...
  public BaseOracleBean[] getDatabeans(ResultSet rs) throws SQLException {
    ...
    return (ArmCsgPosLnItmDtlOracleBean[]) list.toArray(new ArmCsgPosLnItmDtlOracleBean[0]);
  }
