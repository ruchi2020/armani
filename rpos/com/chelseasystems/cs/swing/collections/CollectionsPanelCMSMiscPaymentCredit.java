...
/*
 ...
 +------+------------+-----------+-----------+----------------------------------------------------+
 | 1    | 06/15/2006 | Pankaja   | N/A       | Customizations as per Collections Specifications   |
 --------------------------------------------------------------------------------------------------
 */
...
/**
 */
public class CollectionsPanelCMSMiscPaymentCredit extends CollectionsPanel {
   ...
   */
  public CollectionsPanelCMSMiscPaymentCredit(CollectionsApplet owner, String displayName) {
  ...
  public void jbInit() {
    ...
    lblCollectedAmount.setText("Collected Amount: ");
    txtPrevBalance.setText("Previous Balance: ");
  ...
  public void setPrevBalance(ArmCurrency val) {
    ...
    if (prevBalance != null) {
      this.txtPrevBalance.setText("Previous Balance:   " + prevBalance.formattedStringValue());
    }
  }
...
//      owner.theAppMgr.showErrorDlg(owner.res.getString("Amount must be a value greater than zero"));
    ...
    String sReasonCode = (String)CMSApplet.theAppMgr.getStateObject("REASON_CODE");
    CMSMiscCollectionCredit txn = new CMSMiscCollectionCredit(sReasonCode, (CMSStore)owner.theStore);
