...
/**
 */
public class CollectionsPanelCMSMiscPayment extends CollectionsPanel {
   ...
   */
  public CollectionsPanelCMSMiscPayment(CollectionsApplet owner, String displayName) {
  ...
  public CollectionTransaction exportData()
    ...
    if (commentTxtArea.getText().length() <= 0) {
      ...
      owner.theAppMgr.showErrorDlg(owner.res.getString("The required information is not complete."));
      return null;
    }
