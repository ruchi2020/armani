...
import com.chelseasystems.cs.sos.SOSBootStrap;
...
/**
 */
public class StartofSessionDialog extends JDialog {
  ...
  private boolean isBusinessDateEditable = false;
  /**
   * All Text Fields
   */
   ...
   */
	public StartofSessionDialog(Frame frame, String title, boolean modal, SOSBootStrap bootStrap, IBrowserManager theMgr) {
    ...
    isBusinessDateEditable = config.getString("BUSINESSDATE_EDITABLE_MODE").equalsIgnoreCase("true");
    try {
   ...
   */
    ...
    edtStoreID.setDocument(new TextFilter(TextFilter.NUMERIC));
    //TD
    ...
    */
    ...
    pnlRegister.setLayout(new GridBagLayout());
		pnlRegister.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), res.getString("Initial Settings")));
    pnlUser.setLayout(new GridBagLayout());
    pnlholdFields.setLayout(new GridLayout(2,1));
    ...
    pnlholdFields.add(pnlRegister);
    pnlholdFields.add(pnlUser);
    pnlClient.add(scrStatus, BorderLayout.CENTER);
    pnlClient.add(pnlholdFields, BorderLayout.WEST);
    
    edtPassword.setMaximumSize(edtUserID.getPreferredSize());
    edtPassword.setPreferredSize(edtUserID.getPreferredSize());
		pnlUser.add(lblBusinessdate, new GridBagConstraints(0, 9, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 130, 0));
		pnlUser.add(edtBusinessdate, new GridBagConstraints(0, 10, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
		pnlUser.add(edtDrawerFund, new GridBagConstraints(0, 12, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
		pnlUser.add(edtUserID, new GridBagConstraints(0, 14, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
		pnlUser.add(edtPassword, new GridBagConstraints(0, 16, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
		pnlUser.add(lblDrawerFund, new GridBagConstraints(0, 11, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
		pnlUser.add(lblUserID, new GridBagConstraints(0, 13, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
		pnlUser.add(lblPassword, new GridBagConstraints(0, 15, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
    pnlSouth.add(btnOK, null);
    pnlSouth.add(btnCancel, null);
		pnlRegister.add(lblStoreID, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
		pnlRegister.add(lblRegID, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
		pnlRegister.add(lblRegType, new GridBagConstraints(0, 4, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
		pnlRegister.add(lblRegDesc, new GridBagConstraints(0, 6, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new Insets(0, 6, 2, 9), 0, 0));
		pnlRegister.add(edtRegID, new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
		pnlRegister.add(edtRegType, new GridBagConstraints(0, 5, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
		pnlRegister.add(edtRegDesc, new GridBagConstraints(0, 7, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 9, 9), 0, 5));
		pnlRegister.add(edtStoreID, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL, new Insets(0, 6, 2, 9), 0, 5));
    ...
    if(isBusinessDateEditable){
      edtBusinessdate.setBackground(Color.white);
    }
  ...
  /**
   * Focus on Business Date
   */
  public void requestFocusBusinessDate() {
    SwingUtilities.invokeLater(new Runnable() {

      /**
       */
      public void run() {
        edtBusinessdate.requestFocus();
        focusGot = true;
      }
    });
  }
  ...
  public String getBusinessDate(){
    return edtBusinessdate.getText();
  }
  /**
  ...
  /**
   * Method to update the SOS status
   * @param value a non-resourceable value to describe the status
   * @return String text additional status to add to Status area
   */
  ...
  private void populateInitialValues() {
    ...
    if (register != null) {
      ...
      if (isBusinessDateEditable){
        edtBusinessdate.setEnabled(true);
        edtBusinessdate.setEditable(true);
        edtBusinessdate.setBackground(Color.white);
    }
  ...
  private boolean processStartOfDay() {
    try {
      ...
      if(isBusinessDateEditable){
        if (!bootStrap.validateBusinessDate()){
          edtBusinessdate.requestFocus();
          requestFocusBusinessDate();
          return false;
        }
      }
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (source == btnCancel) {
        bootStrap.cancelButtonPressed();
			} else if (source == btnOK && btnOK.getText().equals(res.getString("Start Processing")) && edtStoreID.getText().equals("")) {
        /**
