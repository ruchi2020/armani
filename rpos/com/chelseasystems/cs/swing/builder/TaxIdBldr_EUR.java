...
/**
 */
public class TaxIdBldr_EUR implements IObjectBuilder {
  ...
  private boolean completeAttributes() {
    if (taxId == null) {
      ...
      theAppMgr.setSingleEditArea(applet.res.getString("Select Tax Exempt Reason."));
      ...
      if (overRideDlg.isOK()) {
        ...
        taxId = "";
        theAppMgr.setSingleEditArea(applet.res.getString("Select options"));
