...
/**
 * <p>Title: RedeemableIsValidAsChange</p>
 ...
 * @version 1.0
 */
public class RedeemableIsValidAsChange extends Rule {

  /**
   * Default Constructor
   */
  public RedeemableIsValidAsChange() {
  }
    ...
    try {
      if (redeemable instanceof StoreValueCard)
        return new RulesInfo(CMSApplet.res.getString(
            "Gift Card is not a valid form of change payment."));
      if (redeemable instanceof DueBill)
        return new RulesInfo(CMSApplet.res.getString(
            "Credit Note is not a valid form of change payment."));
  ...
  public String getName() {
    return CMSApplet.res.getString("Redeemable is not a valid form of change payment.");
  }
  ...
  public String getDesc() {
    ...
    buf.append(CMSApplet.res.getString(
        "Determines whether a Redeemable is allowed as change on this transaction."));
    return buf.toString();
  }
}
