 ...
 * @version 1.0
 */
public class ForeignCashNotValidAsRefundOrChange extends Rule {

  /**
   * put your documentation comment here
   */
  public ForeignCashNotValidAsRefundOrChange() {
  }
   ...
   * @param args - instance of PaymentTransaction
   */
  private RulesInfo execute(Cash cash, PaymentTransaction paymentTransaction1) {
    try { // MP: No need to show Jap Cash in case of PaidOut
      if (paymentTransaction1 instanceof PaidOutTransaction) {
