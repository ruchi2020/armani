 ...
 * @version 1.0
 */
public class ShowIfFiscalModeIsDDT extends Rule {

  /**
   * Default Constructor
   */
  public ShowIfFiscalModeIsDDT() {
  }
  ...
  private RulesInfo execute(CMSMenuOption cmsmenuoption, Employee employee, Store store) {
    try {
      if (CMSApplet.theAppMgr.getStateObject("ARM_PRINT_FISCAL_MODE") != null) {
        ...
        if (iMode != PrintFiscalDocumentApplet.MODE_DDT)
          return new RulesInfo("Cant clear");
      }
    } catch (Exception ex) {
