...
/**
 * <p>Title: NotVATDependentFeature</p>
 * <p>Description: This class checks the business rule that NOT vat dependent
...
public class NotVATDependentFeature extends Rule {
  ...
  private RulesInfo execute(CMSMenuOption cmsmenuoption, Employee employee, Store store) {
    try {
      if (isVatEnabled)
        return new RulesInfo("NOT vat dependent feature should NOT be enabled");
    } catch (Exception ex) {
