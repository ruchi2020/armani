...
/* History:-
 ...
 +--------+------------+-----------+------------------+------------------------------+
 | 1      | 07-13-2005 | Manpreet  | N/A              | Original Version per spec    |
 +--------+------------+-----------+------------------+------------------------------+
 */
/**
 * <p>Title: ShowIfReservationsOpen</p>
 *
 * <p>Description: This business rule check whether SaleMode is RESERVATIONS_OPEN
 * if it is then only DEPOSIT button will show up</p>
 *
 ...
 * @version 1.0
 */
public class ShowIfReservationsOpen extends Rule {

  /**
   * Default Constructor
   */
  public ShowIfReservationsOpen() {
  }
  ...
  private RulesInfo execute(CMSMenuOption cmsmenuoption, Employee employee, Store store) {
    try {
      if (CMSApplet.theAppMgr.getStateObject("TXN_MODE") != null) {
        ...
        if (iMode != InitialSaleApplet.RESERVATIONS_OPEN)
