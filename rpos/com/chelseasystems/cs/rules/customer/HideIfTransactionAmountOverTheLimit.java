...
public class HideIfTransactionAmountOverTheLimit extends Rule {
	  ...
	  private RulesInfo execute(CMSMenuOption cmsmenuoption, Employee employee, Store store) {
	    try {	    	   	
	    	if(CMSApplet.theAppMgr.getStateObject("ARM_TRANSACTION_AMOUNT_OVER_LIMIT")!=null 
	    			&& CMSApplet.theAppMgr.getStateObject("ARM_TRANSACTION_AMOUNT_OVER_LIMIT").equals("TRUE"))	    	
	    		return new RulesInfo("Hide as TransactionAmountOverTheLimit");
	    } catch (Exception ex) {
	  ...
	  public String getName() {
	    return "HideIfTransactionAmountOverTheLimit";
	  }	
