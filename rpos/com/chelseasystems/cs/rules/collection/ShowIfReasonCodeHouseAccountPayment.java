...
/**
 * <p>Title: ShowIfReasonCodeHouseAccountPayment</p>
 * <p>Description: This business rule checks whether the reason code is
 * house account payment  </p>
 * <p>Copyright: Copyright (c) 2005</p>
 * <p>Company: </p>
 * @author Anand
 * @version 1.0
 */
public class ShowIfReasonCodeHouseAccountPayment extends Rule {

  /**
   * Default Constructor
   */
  public ShowIfReasonCodeHouseAccountPayment() {
  }
  ...
  private RulesInfo execute(CMSMenuOption cmsmenuoption) {
    try {
      ...
      if (reasonCode != null && reasonCode.equals("HOUSE_ACCOUNT_PAYMENT"))
  ...
  public String getName() {
    return "ShowIfReasonCodeHouseAccountPayment";
  }
}
