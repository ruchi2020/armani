...
/**
 * <p>Title: ShowIfReasonCodeNFSCheckPayment</p>
 * <p>Description: This business rule checks whether the reason code is
 * NFS Check Payment or not </p>
 * <p>Copyright: Copyright (c) 2005</p>
 * <p>Company: </p>
 * @author Anand
 * @version 1.0
 */
public class ShowIfReasonCodeNFSCheckPayment extends Rule {

  /**
   * Default Constructor
   */
  public ShowIfReasonCodeNFSCheckPayment() {
  }
  ...
  private RulesInfo execute(CMSMenuOption cmsmenuoption) {
    try {
      ...
      if (reasonCode != null && reasonCode.equals("NFS_CHECK_PAYMENT"))
