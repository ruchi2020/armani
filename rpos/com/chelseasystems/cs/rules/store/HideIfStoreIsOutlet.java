...
/**
 * <p>Title: HideIfStoreIsOutlet</p>
 *
 * <p>Description: Hide ALTERATIONS button if its STORE_OUTLET</p>
 *
...
/* History:-
 ...
 +--------+------------+-----------+------------------+------------------------------+
 | 1      | 03-16-2005 | Manpreet  | Original         | Original Version per spec    |
 +--------+------------+-----------+------------------+------------------------------+
 */
public class HideIfStoreIsOutlet extends Rule {
