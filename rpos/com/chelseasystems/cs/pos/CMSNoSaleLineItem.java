 ...
 * @version 1.0
 */
public class CMSNoSaleLineItem extends SaleLineItem {
   ...
   * @param anItem Item
   */
  public CMSNoSaleLineItem(POSTransaction aTransaction, Item anItem) {
   ...
   */
  public CMSNoSaleLineItem(POSTransaction aTransaction, Item anItem, int aSequenceNumber) {
  ...
  public POSLineItemDetail createLineItemDetail() {
    return new CMSNoSaleLineItemDetail(this);
  }
