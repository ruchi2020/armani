 ...
 *
 */
public class DepartmentSalesTotalsDataTransferObject implements java.io.Serializable {
  static final long serialVersionUID = 6773170879114810863L;
   ...
   *
   */
  public DepartmentSalesTotalsDataTransferObject() {
  }
   ...
   * @return
   */
  public ArmCurrency getTotalGrossMkdown() {
    return TotalGrossMkdown;
  }

  /**
   * put your documentation comment here
   * @param AddGrossMkdown
   */
  public void setTotalGrossMkdown(ArmCurrency AddGrossMkdown) {
    this.TotalGrossMkdown = new ArmCurrency(AddGrossMkdown.doubleValue());
  }
