 ...
 */
public class ConsignmentDetailsReportBean extends BaseOracleBean implements Serializable {
  ...
  //new variable for dateIssued only 1923
  public java.util.Date dateCong ;
  ...
  public BaseOracleBean[] getDatabeans(ResultSet rs)
    ...
    while (rs.next()) {
      ConsignmentDetailsReportBean bean = new ConsignmentDetailsReportBean();
      ...
      //1923
      bean.dateCong = new java.util.Date(rs.getDate(COL_DATE_ISSUED).getTime());
    ...
    return (ConsignmentDetailsReportBean[])list.toArray(new ConsignmentDetailsReportBean[0]);
  }
   ...
   * @exception SQLException
   */
  private int getRemainingQty(ConsignmentDetailsReportBean bean, ResultSet rs)
      throws SQLException {
   ...
   * @exception SQLException
   */
  private ArmCurrency getRemainingAmt(ConsignmentDetailsReportBean bean, ResultSet rs)
      throws SQLException {
    try {
