 ...
 */
public class PresaleDetailsReportBean extends BaseOracleBean implements Serializable {
	...
	public BaseOracleBean[] getDatabeans(ResultSet rs) throws SQLException {
		...
		while(rs.next()) {
			PresaleDetailsReportBean bean = new PresaleDetailsReportBean();
		...
		return (PresaleDetailsReportBean[]) list.toArray(new PresaleDetailsReportBean[0]);
	}
	 ...
	 * @exception SQLException
	 */
	private int getRemainingQty(PresaleDetailsReportBean bean, ResultSet rs) throws SQLException {
	 ...
	 * @exception SQLException
	 */
	private ArmCurrency getRemainingAmt(PresaleDetailsReportBean bean, ResultSet rs) throws SQLException {
		try {
