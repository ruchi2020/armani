 ...
 *
 */
public class FiscalAllRowsRenderAction implements RenderActionInterface {

  /**
   * put your documentation comment here
   */
  public FiscalAllRowsRenderAction() {
  }
  ...
  public void renderAction(JLabel cellComponent, JTable table, Object value, boolean isSelected
    ...
    FiscalReportModel model = (FiscalReportModel)sorter.getTableModel();
  ...
  public String getName() {
    return "FiscalReportAllRowsRenderAction";
  }
}
