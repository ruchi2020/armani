 ...
 */
public class ReservationDetailsReportModel extends BaseReportModel {
   ...
   * put your documentation comment here
   */
  public ReservationDetailsReportModel() {
   ...
   */
  public ReservationDetailsReportModel(String[] colhdgs) {
    super(colhdgs);
  }
   ...
   */
  public ReservationDetailsReportModel(ResourceBundle res) {
